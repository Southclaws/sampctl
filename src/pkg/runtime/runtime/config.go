...
func (s *SAMPConfig) Generate(cfg *run.Runtime) error {
	...
	_, err = file.WriteString("echo loading server.cfg generated by sampctl - do not edit this file by hand.\n")
	if err != nil {
		return err
	}
...
func (o *OpenMPConfig) generateLegacyServerCfg(cfg *run.Runtime) error {
	...
	_, err = file.WriteString("# server.cfg generated by sampctl for legacy plugin compatibility\n")
	if err != nil {
