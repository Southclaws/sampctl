...
func Init(
	...
	questions := []*survey.Question{
		...
		},
		{
			Name: "Preset",
			Prompt: &survey.Select{
				Message: "Preset - Which preset do you want to use?",
				Default: preset,
	...
	if answers.Git {
		...
		print.Info("You can use `sampctl release` to apply a version number and release your first version!")
	}
