...
func TestDependencyString_Explode(t *testing.T) {
	tests := []struct {
		...
		{"v u https url path", DependencyString("https://github.com/user/repo_name/inc/path"), Dependency{"user", "repo_name", "inc/path", ""}, false},
		{"v u http url path", DependencyString("http://github.com/user/repo_name/inc/path"), Dependency{"user", "repo_name", "inc/path", ""}, false},
		{"v u naked url path", DependencyString("github.com/user/repo_name/inc/path"), Dependency{"user", "repo_name", "inc/path", ""}, false},
		{"v u user/repo path", DependencyString("user/repo_name/inc/path"), Dependency{"user", "repo_name", "inc/path", ""}, false},
		...
		{"v v https url path", DependencyString("https://github.com/user/repo/inc/path:1.2.3"), Dependency{"user", "repo", "inc/path", "1.2.3"}, false},
		{"v v http url path", DependencyString("http://github.com/user/repo/inc/path:1.2.3"), Dependency{"user", "repo", "inc/path", "1.2.3"}, false},
		{"v v naked url path", DependencyString("github.com/user/repo/inc/path:1.2.3"), Dependency{"user", "repo", "inc/path", "1.2.3"}, false},
		{"v v user/repo path", DependencyString("user/repo/inc/path:1.2.3"), Dependency{"user", "repo", "inc/path", "1.2.3"}, false},
		{"v v user/repo path", DependencyString("user/repo/inc/path:^1.2.3"), Dependency{"user", "repo", "inc/path", "^1.2.3"}, false},
		{"v v user/repo path", DependencyString("user/repo/inc/path:^2.0"), Dependency{"user", "repo", "inc/path", "^2.0"}, false},
		{"v v user/repo path", DependencyString("user/repo/inc/path:2.1.x"), Dependency{"user", "repo", "inc/path", "2.1.x"}, false},
		{"v v user/repo path", DependencyString("user/repo/inc/path:~1"), Dependency{"user", "repo", "inc/path", "~1"}, false},
		{"v v user/repo path", DependencyString("user/repo/inc/path:~2.x"), Dependency{"user", "repo", "inc/path", "~2.x"}, false},
		...
		{"v c https url path", DependencyString("https://github.com/user/repo/inc/path:stable-release-3"), Dependency{"user", "repo", "inc/path", "stable-release-3"}, false},
		{"v c http url path", DependencyString("http://github.com/user/repo/inc/path:stable-release-3"), Dependency{"user", "repo", "inc/path", "stable-release-3"}, false},
		{"v c naked url path", DependencyString("github.com/user/repo/inc/path:stable-release-3"), Dependency{"user", "repo", "inc/path", "stable-release-3"}, false},
		{"v c user/repo path", DependencyString("user/repo/inc/path:stable-release-3"), Dependency{"user", "repo", "inc/path", "stable-release-3"}, false},
