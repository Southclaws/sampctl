...
type Server struct {
	...
	Bind              string `default:""              required:"" json:"bind"`              //
	Password          string `default:""              required:"" json:"password"`          //
	Hostname          string `default:"SA-MP Server"  required:"" json:"hostname"`          // SA-MP Server
	Language          string `default:""              required:"" json:"language"`          //
	...
	Filterscripts     string `default:""              required:"" json:"filterscripts"`     //
	Plugins           string `default:""              required:"" json:"plugins"`           //
	NoSign            string `default:""              required:"" json:"nosign"`            //
